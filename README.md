...
| **Templates** | Eleven built-in templates - Professional Two-Column, Classic Serif, Developer Mono, Structured Slate, Editorial Italic, Contrast Cards, Charcoal Sidebar, Timeline Bars, Indigo Band, Forest Chips and Slate Italic - plus manual and uploaded ones. **View** renders any of them with a full sample resume at the exact page size the PDF prints, so the preview and the output agree |
